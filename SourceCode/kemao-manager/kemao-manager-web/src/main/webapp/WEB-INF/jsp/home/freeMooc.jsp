...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/freeMooc.css" type="text/css" />
...
$(function(){
	...
	var html="";
	$.post("${pageContext.request.contextPath}/getBigtypeList",function(data){
		$.each(data,function (i,item) {
			html+="<div class='shang'><p style='padding-top:60px;' class='xiahua' id='ac"+item.id+"'>"+item.bigtypename+"</p><hr/></div><div class='xiaall'>";
			alert(1);
			$.post("${pageContext.request.contextPath}/getFreeMoocList",{'parentId':item.id},function(data2){
