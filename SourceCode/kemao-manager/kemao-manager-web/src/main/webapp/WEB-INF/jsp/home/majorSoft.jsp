...
<!-- 轮播图start -->
<div id="slider-1" class="bg-fff box-shadow radius"></div>
<!-- 轮播图end -->
...
/* $(function(){
	...
	$.post("${pageContext.request.contextPath}/majorSoft/getStudySoft_b",function(data){
		$.each(data,function(i,e){	
			...
			alert("A:"+"http://kcat-1251241286.cosgz.myqcloud.com/images/"+data[i].jpg);
		});
		html+="</ul></div><ol class='hd cl'>";
		$.each(data,function(i,e){	
			html+="<li><i></i><img src='http://kcat-1251241286.cosgz.myqcloud.com/images/"+data[i].ico+"'></li>";
			alert("B:"+"http://kcat-1251241286.cosgz.myqcloud.com/images/"+data[i].ico);
		});
		html+="</ol></div>";
